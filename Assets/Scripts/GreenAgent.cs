...
public class GreenAgent : Agent
{
    [Header("Specific To Green Agent")]
    ...
    public override void OnActionReceived(float[] vectorAction)
    {
        ...
        {
            Debug.Log("Green Agent Collided");
            CollisionCount += 1;
        ...
        {
            Debug.Log("Green Agent Reached Goal");
            SuccessCount += 1;
    ...
    public override void OnEpisodeBegin()
    {
        ...
        */
        ...
        MyRigidbody.velocity = Vector3.zero;
        MyRigidbody.angularVelocity = Vector3.zero;
        gameObject.transform.position = new Vector3(Random.Range(1.0f, 4.0f), 0.6f, Random.Range(-4.0f, -1.0f)); // Random position
        gameObject.transform.rotation = new Quaternion(0f, 0f, 0f, 0f);
        gameObject.transform.Rotate(new Vector3(0, 1, 0), Random.Range(-90f, 0f)); // Random orientation
        */
